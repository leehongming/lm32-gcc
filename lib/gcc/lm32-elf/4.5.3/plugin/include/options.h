...
#define MASK_BARREL_SHIFT_ENABLED (1 << 0)
#define MASK_DIVIDE_ENABLED (1 << 1)
#define MASK_MULTIPLY_ENABLED (1 << 2)
#define MASK_SIGN_EXTEND_ENABLED (1 << 3)
#define MASK_USER_ENABLED (1 << 4)

#define TARGET_BARREL_SHIFT_ENABLED ((target_flags & MASK_BARREL_SHIFT_ENABLED) != 0)
#define TARGET_DIVIDE_ENABLED ((target_flags & MASK_DIVIDE_ENABLED) != 0)
#define TARGET_MULTIPLY_ENABLED ((target_flags & MASK_MULTIPLY_ENABLED) != 0)
#define TARGET_SIGN_EXTEND_ENABLED ((target_flags & MASK_SIGN_EXTEND_ENABLED) != 0)
#define TARGET_USER_ENABLED ((target_flags & MASK_USER_ENABLED) != 0)
...
enum opt_code
{
  ...
  OPT_mbarrel_shift_enabled,                 /* -mbarrel-shift-enabled */
  OPT_mdivide_enabled,                       /* -mdivide-enabled */
  OPT_mmultiply_enabled,                     /* -mmultiply-enabled */
  OPT_msign_extend_enabled,                  /* -msign-extend-enabled */
  OPT_muser_enabled,                         /* -muser-enabled */
  OPT_nocpp,                                 /* -nocpp */
